...
---
<strong style="background-color: yellow;">该项目为本科毕业设计作品，设计部分较少，以展示程序能力为主。

该项目使用Unity2D引擎开发，使用C#语言完成。玩法设计部分基本参考杀戮尖塔，仅做了卡牌设计和BOSS设计。

由于设计方面占比较少，该项目仅展示一些程序代码。</strong>
